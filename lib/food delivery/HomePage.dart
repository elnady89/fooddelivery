              ...
              child: ListView(
                ...
                children: [
                  ...
                  FadeAnimation(1.5, makeItem(
                    ...
                    price: "250.00",
                    details: "Chicken strips",
                  )),
                  FadeAnimation(1.6, makeItem(
                    image: 'assets/images/Two.jpg',
                    price: "125.00",
                    details: "Combo burger",
                  )),
  ...
  Widget makeCategory({isActive, title}){
    return AspectRatio(
      ...
      child: Container(
        ...
        child: Align(
          child: Text(title , style: TextStyle(color: isActive? Colors.white : Colors.grey, fontSize: 20 , fontWeight:isActive? FontWeight.bold : FontWeight.w600) ,),
        ),
